...
class nav_Core {
	...
	public static function main_tabs($this_page = FALSE, $dontshow = FALSE)
	{
		...
		// Plug in Download Reports
	
				$menu .= "<li><a href=\"".url::site()."reports\download\" ";
				$menu .= ($this_page == 'download_reports') ? " class=\"active\"" : "";
				$menu .= ">".Kohana::lang('ui_main.download_reports')."</a></li>";
